...
function SwimCards(){
    ...
    useEffect(()=>{
    axios.get("https://uptownie.onrender.com/products/category/swim")
    .then(res=>{
    ...
    const handleSearch=async(e)=>{
        ...
        if (value===""){
            ...
            try {
                const res=await axios.get("https://uptownie.onrender.com/products/search/swim/"+value)
                setProducts(res.data)
            } catch (error) {
                console.log(error)
            }
