...
function LovedCards(){
    ...
    useEffect(()=>{
    axios.get("https://uptownie.onrender.com/products/category/most_loved")
    .then(res=>{
    ...
    const handleSearch=async(e)=>{
        ...
        if (value===""){
            ...
            try {
                const res=await axios.get("https://uptownie.onrender.com/products/search/most_loved/"+value)
                setProducts(res.data)
            } catch (error) {
                console.log(error)
            }
