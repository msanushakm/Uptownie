...
function CoordCards(){
    ...
    useEffect(()=>{
    axios.get("https://uptownie.onrender.com/products/category/co_ords")
    .then(res=>{
    ...
    const handleSearch=async(e)=>{
        ...
        if (value===""){
            ...
            try {
                const res=await axios.get("https://uptownie.onrender.com/products/search/co_ords/"+value)
                setProducts(res.data)
            } catch (error) {
                console.log(error)
            }
